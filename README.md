...
🎯 Objectives
Identify distinct customer groups based on spending, income, engagement, and loyalty

Profile each segment with descriptive business names and behavioral tendencies.
Pinpoint high-value segments and those at risk of churn.

Provide actionable recommendations for resource allocation persegment
...
Features
Age, Annual Income, Monthly Spend, Online Visits/Month, Store Visits/Month, Loyalty Score

Source
Simulated real-world customer behavioral data
🔧 Tools & Libraries
Python — pandas, numpy
...
Neither online nor instore visit frequency shows a meaningful correlation with loyalty score, suggesting loyalty is driven by factors beyond visit volume alone.
...
Moderate
Low
Prone to switching; target with loyalty programs

1
Reliable Mainstream Customers
Mixed
Low–Mod
Mid–High
Stable base; upsell opportunities

2
Premium Loyal Advocates
High
High
High
Highest LTV; protect with exclusive perks
...
Moderate–High
Mid
Budget-stretched; flexible payment plans
...
Moderate
Mid
Price-sensitive; cross-sell to upgrade tier
